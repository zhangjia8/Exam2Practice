...
def run_test_practice_problem2a():
    ...
    # Test 1:
    expected = [3, 4, 5, 6, 7]
    answer = practice_problem2a([2, 3, 4, 5, 6], 1)
    print()
    ...
    # Test 2:
    expected = [3, 9, 2, 10]
    answer = practice_problem2a([5, 11, 4, 12], -2)
    print()
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = [5, 2, 8, 11, 23]
    answer = practice_problem2a([5, 2, 8, 11, 23], 0)
    print()
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = [50, 50, 50, 50, 50, 50, 50, 0]
    answer = practice_problem2a([0, 0, 0, 0, 0, 0, 0, -50], 50)
    print()
